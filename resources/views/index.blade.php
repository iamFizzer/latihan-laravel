...
<head>
  ...
  <link rel="stylesheet" href="{{asset('temp')}}/https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{asset('temp')}}/plugins/fontawesome-free/css/all.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{asset('temp')}}/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" data-widget="pushmenu" href="{{asset('temp')}}/#" role="button"><i class="fas fa-bars"></i></a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{asset('temp')}}/index3.html" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{asset('temp')}}/#" class="nav-link">Contact</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      <!-- Navbar Search -->
      <li class="nav-item">
        <a class="nav-link" data-widget="navbar-search" href="{{asset('temp')}}/#" role="button">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="{{asset('temp')}}/#">
          <i class="far fa-comments"></i>
          <span class="badge badge-danger navbar-badge">3</span>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="{{asset('temp')}}/#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
          ...
          <div class="dropdown-divider"></div>
          <a href="{{asset('temp')}}/#" class="dropdown-item dropdown-footer">See All Messages</a>
        </div>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="{{asset('temp')}}/#" class="dropdown-item dropdown-footer">See All Notifications</a>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" data-widget="fullscreen" href="{{asset('temp')}}/#" role="button">
          <i class="fas fa-expand-arrows-alt"></i>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" data-widget="control-sidebar" data-controlsidebar-slide="true" href="{{asset('temp')}}/#" role="button">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="{{asset('temp')}}/index3.html" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="{{asset('temp')}}/#" class="d-block">Alexander Pierce</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="{{asset('temp')}}/#" class="nav-link active">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{asset('temp')}}/./index.html" class="nav-link active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{asset('temp')}}/#">Home</a></li>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2021 <a href="{{asset('temp')}}/https://adminlte.io">AdminLTE.io</a>.</strong>
    All rights reserved.
